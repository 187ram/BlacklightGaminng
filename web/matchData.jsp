...
<%
            ...
            try {
                ...
                numeric = false;
                %>
                    <script>alert("Enter Match Id as Number");</script>
                <%
                }
             }
%>
                ...
                <div class="myDiv">
                    <div>
                        <form method="post" action ="matchData.jsp">
                                ...
                                <div style = "padding:10px;">
                                    <tr> 
                                        ...
                                        <td style="width:50%;height:41px;text-align: center;">
                                            <input class="form-control" style="display: inline-block;width: 50%;" type="text" name ="matchid" value="" >
                            ...
                            <table style="width:80%;margin: auto;border-style: solid;border-width: 1px; border-color: black;">
                                <%
                                ...
                                <tr>
                                    ...
                                    <td id="tdshow"><%=resultSet.getInt("matchId") %></td>
                                </tr>
                                <tr>
                                <form method="post" action ="index.jsp">
                                    ...
                                    <td id="tdshow">
                                        <span style ="margin-left: 118px;">
                                            <%=resultSet.getInt("player1") %>
                                        </span>
                                        <input type="hidden" name="userid" value=<%=resultSet.getInt("player1")%>>
                                ...
                                <form method="post" action ="index.jsp">
                                    ...
                                    <td id="tdshow">
                                        <span style ="margin-left: 118px;">
                                            <%=resultSet.getInt("player2") %>
                                        </span>
                                        <input type="hidden" name="userid" value=<%=resultSet.getInt("player2")%>>
                                        <button style="float:right;" type="submit" class="btn btn-success">SEE DETAILS</button>
                                    </td>
                                </form>
                                </tr>
                                <tr>
                                    ...
                                    <td id="tdshow"><%=resultSet.getTimestamp("matchstartime") %></td>
                                </tr>
                                <tr>
                                    <td id="tddata">Match Won</td>
                                    <td id="tdshow"><%=resultSet.getInt("matchwon") %></td>
                                </tr>
                            </table>
                            <% 
                                 }
